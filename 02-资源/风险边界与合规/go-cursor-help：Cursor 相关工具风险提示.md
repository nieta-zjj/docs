...
**2) 关键点**
*   **项目初衷**：旨在解决 Cursor 免费订阅期间出现的“检测到可疑活动”、“达到试用请求限制”或“本机使用的免费账号过多”等封禁提示。
*   **项目数据**：使用 Shell 语言编写，采用 MIT 开源协议，拥有极高的关注度（25977 Stars，3150 Forks）。
*   **主推商品 (Pro 月卡)**：售卖 Cursor Pro 月度账号，标价 15 美元（官方价值 20-40+ 美元），有效期约 30 天，提供 7 天按比例退款质保。
*   **短期大额通行证**：出售 7 天有效期的企业通行证，额度从 100 美元到 1000 美元不等，售价对应为 30 美元至 350 美元。
*   **基础账号售卖**：出售 5 美元/个的 Cursor 试用账号，以及 50 美元的 Gemini 3.0 Pro 账号（承诺 1 年订阅）。
*   **交易与联系方式**：通过 Telegram (@yuaotian) 和微信 (JavaRookie666) 进行交易，并在 README 中公开招租广告位。

**3) 风险/不足**
*   **合规与封号风险**：项目被明确归类为“风险边界与合规”并带有风险标记（risk_flag: 1）。其提供试用重置工具及倒卖官方账号的行为，严重游走于风险边界。
