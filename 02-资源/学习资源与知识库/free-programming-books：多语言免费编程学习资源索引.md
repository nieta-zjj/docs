---
title: "free-programming-books：多语言免费编程学习资源索引"

发布日期: "2026-02-22"
对象: "GitHub 项目 `EbookFoundation/free-programming-books`"
项目主页: "https://github.com/EbookFoundation/free-programming-books"
...
开源协议: "CC-BY-4.0"
主要语言: "Python"
统计快照: "Stars 382910，Forks 65930，Watchers 9806（抓取时间：2026-02-22）"
版本快照: "无正式 release（Release 总数 0）"
备注: "用户提供“27197”，与当前公开 Stars 统计不一致；本条目按抓取时公开数据记录。"
---
...
- 多目录分类：`books`、`courses`、`casts`、`more` 等目录分别维护不同类型资源。
