...
- [[01-博客/Hugging Face/社区评估：打破黑盒排行榜，将评估权交还社区.md|社区评估：打破黑盒排行榜，将评估权交还社区]]；关联理由：解说；说明：两文都聚焦模型评估的可信性与可解释性，前者提供方言基准实证，后者讨论评估体系治理。
- [[01-博客/Hugging Face/RTEB：检索评测新标准.md|RTEB：检索评测新标准]]；关联理由：延伸思考；说明：两文都属于“构建任务导向基准并比较模型表现”的评测范式，可互补理解评测设计方法。
